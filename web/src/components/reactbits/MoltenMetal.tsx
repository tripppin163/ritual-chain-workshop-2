...
/*
 * MoltenMetal — vendored from React Bits (https://reactbits.dev/backgrounds/molten-metal),
 * MIT licensed and published to be copied into a project rather than installed.
 * Local changes: the "use client" directive Next needs, plus two spots where an
 * optional index is guarded — hexToRgb destructures
 * its regex match instead of indexing it, so the file typechecks under this project's
 * noUncheckedIndexedAccess, and the IntersectionObserver entry is read optionally.
 */
